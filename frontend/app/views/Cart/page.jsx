...
const page = () => {
  ...
  return (
    <div>
      ...
      {isloading ? (
        <p className="items-center text-center text-4xl font-bold my-32">
          loading....
        </p>
      ) : (
        <>
          {mycart.length > 0 ? (
            ...
            <>
              <p className="items-center text-center text-4xl font-bold my-13">
                your cart is empty
              </p>
              <Link href="/views/Products">
                <p className="items-center text-center text-2xl font-semibold underline text-blue-600 cursor-pointer my-13">
                  add somthing
                </p>{" "}
              </Link>
            </>
