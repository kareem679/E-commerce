...
import CheckoutPayPart from "./parts/CheckoutPayPart";

const CheckoutCom = ({ total, subtotal, setmycart, setisloading,mycart }) => {
  return (
    <div className="flex justify-center w-full p-12">
      <div className="w-full max-w-xl bg-white shadow-lg rounded-2xl p-6 flex flex-col gap-6">
        ...
        <CheckoutPayPart setmycart={setmycart} setisloading={setisloading} mycart={mycart} />
      </div>
    </div>
  );
};
