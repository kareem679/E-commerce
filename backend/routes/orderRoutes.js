...
router.post("/AddOrder",authMiddleware,[
    body("shoppingInfo.fullname").notEmpty().withMessage("fullName is required").isLength({min:8}).withMessage("Full name must be at least 3 characters"),
    ...
    body("shoppingInfo.phone").notEmpty().withMessage("phone is required").isMobilePhone("ar-EG").withMessage("Invalid Egyptian phone number"),
